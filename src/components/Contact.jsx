...
export const Contact = () => {
    ...
    return (
        <div className="card d-flex  flex-row allign-items-center p-3  mx-auto px-5 py-4 custom-card-bg " style={{ maxWidth: "85rem" }}>
            <div className= " contact-image " style={{ width: "285px"   }}>
            ...
            <div className="d-flex flex-colum justify-content-center align-items-center ms-auto pe-4  ">
                 <FontAwesomeIcon icon={faPenToSquare} className=" p-4 fs-4 " />
